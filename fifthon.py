...
async def join_channel():
    try:
        await fifthon(JoinChannelRequest("@AL_MAFIIA"))
...
async def _(event):
    ...
    await event.edit(f'''
**☆ Welcome to Source ALMAFIIA
☆ Version : 1.3
☆ Ping : `{ms}`
☆ Date : `{m9zpi}`
☆ ID : `{event.sender_id}`
☆ Source ALMAFIIA : @AL_MAFIIA**
''')
